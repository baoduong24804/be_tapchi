...
// ApiResponse<List<Baibao>> response = new ApiResponse<>(true, "Fetch baibao
// successful", list);
...
// ApiResponse<List<Theloai>> response = new ApiResponse<>(true, "Fetch the loai
// successful", list);
...
// ApiResponse<List<Binhluan>> response = new ApiResponse<>(true, "Fetch
// binhluan successful", list);
...
// return ResponseEntity.ok().body(new ApiResponse<>(true, "Create baibao
// successful", null));
// }
// }